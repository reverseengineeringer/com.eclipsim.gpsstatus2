...
public abstract interface ﺕ
  extends IInterface
{
  public abstract void ᐩ(String paramString);
  
  public abstract void ᒽ(boolean paramBoolean);
  
  public abstract void ᓹ();
  
  public abstract void ᵔ(float paramFloat);
