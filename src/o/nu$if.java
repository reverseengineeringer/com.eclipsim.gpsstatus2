  ...
  implements nu
{
    ...
    case 1: 
      ...
      else
      {
        ...
        if ((localIInterface != null) && ((localIInterface instanceof nn))) {
          paramParcel1 = (nn)localIInterface;
        } else {
          paramParcel1 = new nn.if.if(paramParcel1);
        }
      }
      ˊ(paramParcel1);
    ...
    implements nu
  {
    ...
    public final void ˊ(nn paramnn)
    {
      ...
      for (;;)
      {
        try
        {
          ...
          if (paramnn != null)
          {
            paramnn = paramnn.asBinder();
            localParcel1.writeStrongBinder(paramnn);
