...
public abstract interface צּ
  extends IInterface
{
  public abstract IBinder ˊ(hu paramhu, AdSizeParcel paramAdSizeParcel, String paramString, sl paramsl, int paramInt);
  
  public abstract IBinder ˊ(hu paramhu, AdSizeParcel paramAdSizeParcel, String paramString, sl paramsl, int paramInt1, int paramInt2);
