...
public abstract interface hr
  extends IInterface
{
  public abstract void ˊ(Status paramStatus, FetchConfigIpcResponse paramFetchConfigIpcResponse);
  
  public abstract void ˊ(Status paramStatus, HashMap paramHashMap);
  
  public abstract void ˊ(Status paramStatus, byte[] paramArrayOfByte);
