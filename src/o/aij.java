...
public abstract interface aij
  extends IInterface
{
  public abstract void ˊ(int paramInt, Account paramAccount, aii paramaii);
  
  public abstract void ˊ(AuthAccountRequest paramAuthAccountRequest, aii paramaii);
  
  public abstract void ˊ(ResolveAccountRequest paramResolveAccountRequest, gj paramgj);
  
  public abstract void ˊ(CheckServerAuthResult paramCheckServerAuthResult);
  
  public abstract void ˊ(RecordConsentRequest paramRecordConsentRequest, aii paramaii);
  
  public abstract void ˊ(SignInRequest paramSignInRequest, aii paramaii);
  
  public abstract void ˊ(aii paramaii);
  
  public abstract void ˊ(ge paramge, int paramInt, boolean paramBoolean);
  
  public abstract void ᐤ(boolean paramBoolean);
  
  public abstract void ᒃ(int paramInt);
