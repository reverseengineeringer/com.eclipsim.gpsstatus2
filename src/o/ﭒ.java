...
public abstract interface ﭒ
  extends IInterface
{
  public abstract 乀 createAdLoaderBuilder(hu paramhu, String paramString, sl paramsl, int paramInt);
  
  public abstract tv createAdOverlay(hu paramhu);
  
  public abstract ﬥ createBannerAdManager(hu paramhu, AdSizeParcel paramAdSizeParcel, String paramString, sl paramsl, int paramInt);
  
  public abstract ue createInAppPurchaseManager(hu paramhu);
  
  public abstract ﬥ createInterstitialAdManager(hu paramhu, AdSizeParcel paramAdSizeParcel, String paramString, sl paramsl, int paramInt);
  
  public abstract nl createNativeAdViewDelegate(hu paramhu1, hu paramhu2);
  
  public abstract ᵆ createRewardedVideoAd(hu paramhu, sl paramsl, int paramInt);
  
  public abstract ﬥ createSearchAdManager(hu paramhu, AdSizeParcel paramAdSizeParcel, String paramString, int paramInt);
  
  public abstract ﺕ getMobileAdsSettingsManager(hu paramhu);
  
  public abstract ﺕ getMobileAdsSettingsManagerWithClientJarVersion(hu paramhu, int paramInt);
