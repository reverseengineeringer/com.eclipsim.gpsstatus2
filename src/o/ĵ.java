  ...
  implements ᓐ
{
  ...
  public ĵ(Context paramContext)
  {
    this(paramContext, null);
  }
  
  public ĵ(Context paramContext, AttributeSet paramAttributeSet)
  {
    this(paramContext, paramAttributeSet, ｧ.if.autoCompleteTextViewStyle);
  }
  
  public ĵ(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
