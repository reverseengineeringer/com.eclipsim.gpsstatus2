...
public abstract interface ᒍ
  extends IInterface
{
  public abstract int ˊ(int paramInt, String paramString1, String paramString2);
  
  public abstract Bundle ˊ(int paramInt, String paramString1, String paramString2, Bundle paramBundle);
  
  public abstract Bundle ˊ(int paramInt, String paramString1, String paramString2, String paramString3);
  
  public abstract Bundle ˊ(int paramInt, String paramString1, String paramString2, String paramString3, String paramString4);
  
  public abstract Bundle ˊ(int paramInt, String paramString1, List<String> paramList, String paramString2, String paramString3, String paramString4);
  
  public abstract int ˋ(int paramInt, String paramString1, String paramString2);
  
  public abstract int ˎ(int paramInt, String paramString1, String paramString2);
