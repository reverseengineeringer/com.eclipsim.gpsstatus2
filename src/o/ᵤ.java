...
class ᵤ
{
  public static void ˊ(Notification.Builder paramBuilder, Ⅰ.if paramif)
  {
    Notification.Action.Builder localBuilder = new Notification.Action.Builder(paramif.getIcon(), paramif.getTitle(), paramif.І());
    if (paramif.ї() != null)
    {
      RemoteInput[] arrayOfRemoteInput = ﺗ.ˊ(paramif.ї());
