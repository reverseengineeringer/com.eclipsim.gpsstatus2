...
{
  private static ec.ᐝ<ail> aRC;
  public static final ec.ˊ<ail, afc> aRD;
  private static ec.ˊ<ail, if> aRE;
  private static ec.ᐝ<ail> aaC = new ec.ᐝ();
  public static final ec<afc> aaE;
  ...
  static
  {
    ...
    new Scope("profile");
    new Scope("email");
    aaE = new ec("SignIn.API", aRD, aaC);
    new ec("SignIn.INTERNAL_API", aRE, aRC);
  }
