...
public abstract interface ld
  extends IInterface
{
  public abstract void ʹ(String paramString1, String paramString2);
  
  public abstract boolean ˈ(hu paramhu);
  
  public abstract boolean ˉ(hu paramhu);
  
  public abstract String ˊ(hu paramhu, String paramString);
  
  public abstract hu ˊ(hu paramhu1, hu paramhu2);
  
  public abstract hu ˋ(hu paramhu1, hu paramhu2);
  
  public abstract String ˌ(hu paramhu);
  
  public abstract void ˍ(hu paramhu);
  
  public abstract boolean ˏ(String paramString, boolean paramBoolean);
  
  public abstract void ৲(String paramString);
  
  public abstract String ผ();
