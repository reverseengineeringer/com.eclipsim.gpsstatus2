...
public abstract interface nt
  extends IInterface
{
  public abstract String ᑊ(String paramString);
  
  public abstract nj ᕀ(String paramString);
  
  public abstract String ᴋ();
  
  public abstract void ᵕ(String paramString);
  
  public abstract List<String> Ḷ();
