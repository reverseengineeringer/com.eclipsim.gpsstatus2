...
public final class ৰ
{
  ...
  public ৰ(long paramLong, String paramString, ৰ paramৰ)
  {
    Ie = paramLong;
    If = paramString;
    Ig = paramৰ;
  ...
  public static final class if
  {
    ...
    public final Map<String, ৰ> Ih;
    public final ৰ.ˊ Ii;
    
    public if() {}
    
    public if(ৰ.ˊ paramˊ)
    {
      Ii = paramˊ;
      Ih = new HashMap();
    }
  ...
  public static final class ˊ
  {
    ...
    public ˊ(boolean paramBoolean, String paramString1, String paramString2)
    {
      Ik = new LinkedList();
